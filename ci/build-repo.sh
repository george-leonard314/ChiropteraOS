...
read -r -a packages <<<"${PACKAGES:-app2unit pacseek evdi-dkms displaylink chiroptera-shell chiroptera-dots chiroptera-zen-theme chiroptera-wifi-secrets chiroptera-meta chiroptera-hwd chiroptera-themes chiroptera-calamares-config kmg}"
...
#               chiroptera-themes, chiroptera-zen-theme,
#               chiroptera-wifi-secrets and
...
declare -A extra_flags=(
    ...
    [chiroptera-wifi-secrets]="--nodeps"
)
